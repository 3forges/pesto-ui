...
export default function NavbarWithDropdown() {
  ...
  const [ const_github_oauth_client_id,
    ...
    `http%3A%2F%2Fui.pesto.io%3A5173%2Foauth%2Fgithub%2Fcallback`, // github_oauth_redirect_uri
  ]
  /**
   * Sidebar collapse
   */
      ...
      <div className="flex md:order-2">
        ...
        >
          ...
          <Button gradientDuoTone="pinkToOrange" onClick={() => {
                console.log(``)
                window.location.href = `http://keycloak.pesto.io:8081/auth/realms/pesto/protocol/openid-connect/auth?response_type=token&client_id=pesto-oidc-client-id&redirect_uri=http%3A%2F%2Fui.pesto.io%3A5173%2Fauth%2Foidc%2Fkeycloak`
            }}>
