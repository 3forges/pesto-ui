    ...
    <>
      <Flowbite theme={{ theme: customTheme }}>
        ...
        <div class="flex">
          ...
          <aside id="pesto-sidebar" class={`transition-all z-40 ${isSideBarOpened?`w-50`:`w-0`} h-screen transition-transform -translate-x-full sm:translate-x-0`} aria-label="Sidenav">
