  ...
  {//https://github.com/preactjs/preact-router/issues/405#issuecomment-927369168
    // <PestoProjectContentMgmt path="/projects/:id" project={{_id: parseInt(":id"), name: "fake", description: "fake", git_ssh_uri: "faketoo"}}/>
  }
  interface PestoProjectContentMgmtProps {
  ...
  export const PestoProjectContentMgmtUI: FunctionalComponent<PestoProjectContentMgmtProps> = ({ project_id }: PestoProjectContentMgmtProps): JSX.Element => {
    console.log(`[PestoProjectContentMgmt] - project_id: `, project_id)
    /**
  ...
  // export default PestoProjectContentMgmt